...
pl= m.addMVar(1,name='pl')
ql= m.addMVar(1,name='ql')
...
m.addConstr(gp.quicksum(EqNp[i] for i in range(num_nodes))==pl, name='c-ppl')
m.addConstr(gp.quicksum(EqNq[i] for i in range(num_nodes))==ql, name='c-pql')
