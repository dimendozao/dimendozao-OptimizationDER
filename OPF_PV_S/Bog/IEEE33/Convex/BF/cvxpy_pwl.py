...
#OPFSOC.solve(solver=cvx.MOSEK,mosek_params={'MSK_IPAR_MIO_DATA_PERMUTATION_METHOD':'MSK_MIO_DATA_PERMUTATION_METHOD_RANDOM'},verbose=True)    

#print(OPFSOC.status,obj.value,OPFSOC.solver_stats.solve_time)

#mosek_params={}
#'MSK_IPAR_MIO_SEED':50
#'MSK_IPAR_MIO_DATA_PERMUTATION_METHOD':'MSK_MIO_DATA_PERMUTATION_METHOD_RANDOM'
