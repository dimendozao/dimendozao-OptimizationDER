...
"----- Read the database -----"
branch = pad.read_csv("C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Systems\\CA141Branch.csv")
bus= pad.read_csv("C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Systems\\CA141Bus.csv")
gen= pad.read_csv("C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Systems\\CA141Gen.csv")
...
for h in range(H):
    pd.value=pdm[h]
    qd.value=qdm[h]
    OPFSOC.solve(solver=cvx.MOSEK,canon_backend=cvx.SCIPY_CANON_BACKEND,enforce_dpp=True,accept_unknown=True,mosek_params = {'MSK_IPAR_INTPNT_SOLVE_FORM':'MSK_SOLVE_PRIMAL','MSK_IPAR_PRESOLVE_USE':'MSK_PRESOLVE_MODE_OFF'},verbose=True)    
