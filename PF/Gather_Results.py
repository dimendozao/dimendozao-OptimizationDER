...
for cs in range(ncase):
    ...
    for i in range(nform):
        if i<nform-1 and not i==6 and not i==11:
            datadict.update({form[i]:pd.read_excel('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\'+conv[i]+'\\'+fold[i]+'\\'+form[i]+'\\Results.xlsx',index_col=0)})
        elif i==6 or i==11:
            datadict.update({form[i]:pd.read_excel('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\'+conv[i]+'\\'+fold[i]+'\\Results.xlsx',index_col=0)})
        else:    
            datadict.update({form[i]:pd.read_csv('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\'+conv[i]+'\\Results.csv')})
    ...
    file = open('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\Results_tab.txt','w')
    file.write(latexresults)
    file.close() 
    
    file = open('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\Overview_tab.txt','w')
    ...
    resultsdf1.to_csv('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\matdifs.csv')
    overviewdf1.to_csv('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\overview.csv')
    ...
    bestresult.to_csv('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+case[cs]+'\\best.csv')
...
file = open('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\MatSol_tab.txt','w')
