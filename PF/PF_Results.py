...
for i in range(ncases):
    if i==0:
        pfdf=pd.read_csv('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+cases[i]+'\\best.csv',header=0,index_col=0)
    else:
        pfdf=pd.concat([pfdf,pd.read_csv('C:\\Users\\diego\\OneDrive\\Desktop\\aLL\\PhD\\Tesis\\Python\\'+problem+'\\'+cases[i]+'\\best.csv',header=0,index_col=0)])
...
file = open('PF_Results_tab.txt','w')
